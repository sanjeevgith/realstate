<%@ Page Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="RequestView.aspx.cs" Inherits="RequestView"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center">
        <tr>
            <td style="width: 100px; height: 17px;">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Request.aspx" Width="79px">Add Request</asp:HyperLink></td>
        </tr>
        <tr>
