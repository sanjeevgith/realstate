<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="EstateUpdate.aspx.cs" Inherits="Admin_EstateUpdate"  %>
...
<script language=javascript>
    ...
    <table align="center">
        ...
        <tr>
            ...
            <td>
                :</td>
            <td>
                <asp:RadioButtonList ID="optStatus" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                    <asp:ListItem Value="Y">Sale</asp:ListItem>
                    <asp:ListItem Selected="True" Value="N">Not Sale</asp:ListItem>
        ...
        <tr id=sale1 style="display:none">
            ...
            <td>
                :</td>
            <td>
                <asp:TextBox ID="txtDate" runat="server" Width="93px" ReadOnly="True"></asp:TextBox>
                <asp:ImageButton ID="imgCalc" runat="server" CausesValidation="False" ImageUrl="~/Images/Calendar.png" /></td>
        </tr>
        <tr id=sale2 style="display:none">
            ...
            <td>
                :</td>
            <td>
                <asp:TextBox ID="txtRemarks" runat="server" MaxLength="200" Rows="3" TextMode="MultiLine"
        ...
        <tr>
            <td colspan="3" align=center bgcolor="buttonface">
                <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="Update" />&nbsp;<asp:Button
                    ID="btnBack" runat="server" CausesValidation="False" PostBackUrl="~/Admin/EstateView.aspx"
                    Text="Back" Width="74px" /></td>
        </tr>
    </table>
    <br />
    ...
    <cc1:calendarextender id="CalendarExtender1" runat="server" popupbuttonid="imgCalc"
